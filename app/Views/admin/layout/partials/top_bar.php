    ...
    <div class="main-header-logo">
        ...
        <div class="logo-header" data-background-color="dark">
            <a href="../index.html" class="logo">
                <img src="<?= assets_url('admin/img/kaiadmin/logo_light.svg') ?>" alt="navbar brand"
            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm">
                            <img src="<?= base_url('uploads/avatars/') . logged('avatar') ?>" alt="..."
                                class="avatar-img rounded-circle" />
                        </div>
                        <span class="profile-username">
                            <span class="op-7">Hi,</span>
                            <span class="fw-bold"><?= logged('first_name') . ' ' . logged('last_name'); ?></span>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg">
                                        <img src="<?= base_url('uploads/avatars/') . logged('avatar') ?>"
                                            alt="image profile" class="avatar-img rounded" />
                                    </div>
                                    <div class="u-text">
                                        <h4> <?= logged('first_name') . ' ' . logged('last_name'); ?></h4>
                                        <p class="text-muted"><?= logged('email') ?></p>
