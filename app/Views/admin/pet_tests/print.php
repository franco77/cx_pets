...
<body>
    ...
    <div class="container">
                ...
                <td width="30%">
                    <div class="info-section">
                        ...
                        <table class="table">
                            <tr>
                                <th>Nombre</th>
                                <td><?= htmlspecialchars($data['pet_name']) ?></td>
                            </tr>
                            <tr>
                                <th>Especie</th>
                                <td><?= htmlspecialchars($data['specie_name']) ?></td>
                            </tr>
                            <tr>
                                <th>Raza</th>
                                <td><?= htmlspecialchars($data['breed_name']) ?></td>
                            </tr>
                ...
                <tbody>
                    <?php foreach ($data['details'] as $detail): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($detail['result']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="footer">
            <p>Fecha de la Prescripción Test: [<?= htmlspecialchars($data['created_at']) ?>]</p>
