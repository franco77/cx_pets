...
class PrescriptionDetailsModel extends Model
{
   protected $table      = 'prescription_details';
   protected $primaryKey = 'id';
   protected $allowedFields = ['prescription_id', 'product_id', 'product_name', 'dosage', 'frequency'];
   protected $searchFields = ['prescription_id', 'product_name', 'dosage', 'frequency',];
   ...
   public function filter($search = null, $limit = null, $start = null, $orderField = null, $orderDir = null)
   {
      ...
      $builder->select('id, prescription_id, product_name, dosage, frequency, ')
   ...
   public function countFilter($search)
   {
      ...
      return $builder->join('prescriptions', 'prescriptions.id = prescription_details.prescription_id')
         ->countAllResults();
   }
}
